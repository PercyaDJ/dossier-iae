...
Alors voici le cahier des charges du projet :
CAHIER DES CHARGES DU PROJET POUR LES M2 CMSI 1. Titre : “Analyse du marché Airbnb & modélisation : guider une IA Générative comme votre assistant technique”. 2. Contexte général du projet Vous êtes Business Analyste dans une société de conseil spécialisée en marché touristique. Votre rôle : analyser la dynamique du marché Airbnb d’une ville donnée en utilisant un dataset réel. Vous ne codez pas vous-même : • Vous fournissez des instructions claires et structurées à une IA Générative (votre “assistant technique”). • Vous évaluez ensuite la qualité de ses réponses (exactitude, pertinence, limites, biais). • Vous introduisez les éléments que vous jugerez les plus pertinents à votre analyse. • Site pour récupérer les datasets : https://insideairbnb.com/get-the-data/ • Prenez les versions simplifiées du dataset et pas la version complète. 3. Objectifs pédagogiques Ce projet évalue votre capacité à : • Comprendre un problème métier. • Rédiger des prompts efficaces. • Évaluer la qualité des réponses de l’IA. • Réaliser une analyse rigoureuse du marché. • (En groupe) Construire un récit analytique cohérent. • (En groupe) Formuler des recommandations exploitables. • (En groupe) Mettre en place une régression et l’interpréter. 4. Le projet est constitué de deux parties : 4.1. PARTIE 1 - PROJET INDIVIDUEL : Analyse du marché Airbnb à Amsterdam Vous réaliserez seul.e une analyse du marché Airbnb d'Amsterdam. Objectifs : • Comprendre la dynamique du marché local. • Explorer les prix, quartiers, disponibilité, hôtes. • Détecter les outliers et décidez ce que vous voulez en faire. • Produire des insights business. • Critiquer les réponses de l’IA et améliorer ses prompts jusqu’à arriver à un résultat satisfaisant. 4.2. PARTIE 2 - PROJET DE GROUPE : Analyse d’une ville au choix + Modélisation du prix En groupe, vous choisissez la ville de votre choix (e.g., Paris, Berlin, Barcelone, Lisbonne, New York, etc.). Objectifs : • Réaliser l’analyse exploratoire complète (EDA), comme dans la partie individuelle. • Construire une régression pour expliquer les prix Airbnb : o Régression linéaire. o Explication des variables choisies. o Interprétation des coefficients. o Analyse des limites du modèle. • Produire des recommandations avancées pour quelqu’un qui souhaiterait investir dans un bien dans la ville choisie (segmentation, pricing strategy, opportunités de marché). 5. Livrables (communs aux deux projets) 5.1. Un Notebook (Jupyter / Colab) Doit contenir : • Le code qui vous a permis de faire les analyses. • Les analyses finales (tableaux, graphiques, commentaires). • Vos interprétations des analyses. Pour le projet de groupe : inclure une section modélisation des prix (régression). 5.2. Vos interactions avec l’IA : Un lien vers votre discussion avec GenAI, ou à défaut un PDF où l’ensemble de votre discussion est copié, contenant : • Vos prompts (instructions envoyées à l’IA). • Les réponses de l’IA. 5.3. Un Rapport Business (Pour le projet de groupe) Format : 10–12 slides maximum. Faites comme si vous alliez présentez vos résultats à un commanditaire qui souhaite comprendre l’état du marché Airbnb dans la ville que vous avez choisi. Cette présentation devra contenir des réponses à des questions de base, e.g. : • Insights essentiels du marché. • Graphiques clés. • Analyse des prix, quartiers, disponibilité, hôtes. • Analyse de la demande. • Segmentation (optionnelle mais valorisée). • Modélisation des prix et les variables qui influences les prix. • Recommandations métier claires et actionnables pour un investisseur immobilier dans la ville que vous aurez choisi. Aucun code ne doit apparaître dans le rapport. 6. Questions clés que vous devez aborder (Valables pour les deux projets, avec un volet supplémentaire pour la régression en groupe) 6.1. Vue d’ensemble du marché • Combien de listings par quartier ? • Quels niveaux de prix ? • Quelle structure du marché ? 6.2. Analyse des prix • Quartiers les plus chers ? • Quels facteurs semblent influencer le prix ? • Y a-t-il des outliers importants ? o Faut-il les retirer ? Pourquoi ? 6.3. Analyse des hôtes et des avis • Les superhosts facturent-ils plus cher ? s’ils existent. • Le nombre d’avis est-il lié à la disponibilité ou au prix ? • Y a-t-il des hôtes professionnels (multi-listings) ? 6.4. Indicateurs de demande • Disponibilité moyenne selon les quartiers • Quartiers les plus recherchés • Saisonnalité potentielle (si disponible) 6.5. Segmentation (optionnelle mais recommandée) • Groupes de listings (budget / luxe / familles / long séjour, etc.) 6.6. Modélisation (uniquement projet de groupe) • Construire une régression des prix Airbnb • Choisir les variables pertinentes (ex : nombre de chambres, quartier, type de logement…) • Expliquer : o La logique métier derrière les variables. o Les coefficients du modèle. o Les limites du modèle (multicolinéarité, outliers, etc.). 7. Critères d’évaluation Vous serez évalué sur les critères suivants : 7.1. Critères d’évaluation des travaux individuels Critère Description Note Qualité des prompts Clarté, précision, structuration, adaptation à l’objectif /5 Evaluation critique des réponses IA Pertinence, capacité à repérer erreurs & limites et à rediriger l’IA vers la bonne direction /5 Profondeur analytique Qualité de l’EDA, cohérence des analyses réalisées avec du code avec les interprétations. /5 Visualisation EDA Qualité, lisibilité, choix des graphes /3 Bonus Traitement des outliers. Pertinence de la segmentation. Véritable complémentarité avec GenAI lors du travail. /2 7.2. Critères d’évaluation des travaux de groupe Critère Description Note Qualité des prompts (note individuelle pour chacun des membres du groupe) Clarté, précision, structuration, adaptation à l’objectif /2 Evaluation critique des réponses IA (note individuelle pour chacun des membres du groupe) Pertinence, capacité à repérer erreurs & limites et à rediriger l’IA vers la bonne direction /2 Profondeur analytique Qualité de l’EDA, cohérence des analyses réalisées avec du code avec les interprétations. /2 Visualisation EDA Qualité, lisibilité, choix des graphes /2 Qualité de la régression et son interprétation Le choix des variables prédictives su prix et sa justification, la préparation des variables, les essaie pour améliorer les scores de confiance, l’interprétation des coefficient de régression. /2 Qualité du rapport finale Structure, storytelling, insights, recommandations /5 Présentation finale Storytelling, insights et recommandations. Réponse aux différentes questions. /5 Note : La majorité des points pour le travail de groupes sont attribués aux livrables de présentation. Cependant, pour fournir des rapports finaux de qualité, il vous faudra mener à bien toutes les étapes d’analyse qui les sous-tendent.



Je voudrais que tu analyses encore le notebook voir ce qui est améliorable, je suis dans la partie individuelle mais sur le listing d'oslo, je vais le dupliqué par la suite pour faire la même analyse sur le listing d'Asterdam et basculé la partie analyse d'Oslo dans le travail de groupe
...
du coup on est d'accord que tu me fais l'analyse complète en gardant ce qu'on a fait mais en améliorant pour que je puisse utiliser le notebook d'Oslo pour le projet de groupe et qu'en changeant juste le fichier de listing par celui d'Amsterdam pour faire le projet individuelle ?
...
alors je te demande de ne rien supprimer de l'existant que ça soit dans le notebook ou dans les interraction, tu dois affiner ou répondre à toute les exigences demandé pour le travail de groupe donc tout ça : 
4.2. PARTIE 2 - PROJET DE GROUPE : Analyse d’une ville au choix + Modélisation du prix En groupe, vous choisissez la ville de votre choix (e.g., Paris, Berlin, Barcelone, Lisbonne, New York, etc.). Objectifs : • Réaliser l’analyse exploratoire complète (EDA), comme dans la partie individuelle. • Construire une régression pour expliquer les prix Airbnb : o Régression linéaire. o Explication des variables choisies. o Interprétation des coefficients. o Analyse des limites du modèle. • Produire des recommandations avancées pour quelqu’un qui souhaiterait investir dans un bien dans la ville choisie (segmentation, pricing strategy, opportunités de marché). 5. Livrables (communs aux deux projets) 5.1. Un Notebook (Jupyter / Colab) Doit contenir : • Le code qui vous a permis de faire les analyses. • Les analyses finales (tableaux, graphiques, commentaires). • Vos interprétations des analyses. Pour le projet de groupe : inclure une section modélisation des prix (régression). 5.2. Vos interactions avec l’IA : Un lien vers votre discussion avec GenAI, ou à défaut un PDF où l’ensemble de votre discussion est copié, contenant : • Vos prompts (instructions envoyées à l’IA). • Les réponses de l’IA. 5.3. Un Rapport Business (Pour le projet de groupe) Format : 10–12 slides maximum. Faites comme si vous alliez présentez vos résultats à un commanditaire qui souhaite comprendre l’état du marché Airbnb dans la ville que vous avez choisi. Cette présentation devra contenir des réponses à des questions de base, e.g. : • Insights essentiels du marché. • Graphiques clés. • Analyse des prix, quartiers, disponibilité, hôtes. • Analyse de la demande. • Segmentation (optionnelle mais valorisée). • Modélisation des prix et les variables qui influences les prix. • Recommandations métier claires et actionnables pour un investisseur immobilier dans la ville que vous aurez choisi. Aucun code ne doit apparaître dans le rapport. 6. Questions clés que vous devez aborder (Valables pour les deux projets, avec un volet supplémentaire pour la régression en groupe) 6.1. Vue d’ensemble du marché • Combien de listings par quartier ? • Quels niveaux de prix ? • Quelle structure du marché ? 6.2. Analyse des prix • Quartiers les plus chers ? • Quels facteurs semblent influencer le prix ? • Y a-t-il des outliers importants ? o Faut-il les retirer ? Pourquoi ? 6.3. Analyse des hôtes et des avis • Les superhosts facturent-ils plus cher ? s’ils existent. • Le nombre d’avis est-il lié à la disponibilité ou au prix ? • Y a-t-il des hôtes professionnels (multi-listings) ? 6.4. Indicateurs de demande • Disponibilité moyenne selon les quartiers • Quartiers les plus recherchés • Saisonnalité potentielle (si disponible) 6.5. Segmentation (optionnelle mais recommandée) • Groupes de listings (budget / luxe / familles / long séjour, etc.) 6.6. Modélisation (uniquement projet de groupe) • Construire une régression des prix Airbnb • Choisir les variables pertinentes (ex : nombre de chambres, quartier, type de logement…) • Expliquer : o La logique métier derrière les variables. o Les coefficients du modèle. o Les limites du modèle (multicolinéarité, outliers, etc.). 7. Critères d’évaluation Vous serez évalué sur les critères suivants : 7.1. Critères d’évaluation des travaux individuels Critère Description Note Qualité des prompts Clarté, précision, structuration, adaptation à l’objectif /5 Evaluation critique des réponses IA Pertinence, capacité à repérer erreurs & limites et à rediriger l’IA vers la bonne direction /5 Profondeur analytique Qualité de l’EDA, cohérence des analyses réalisées avec du code avec les interprétations. /5 Visualisation EDA Qualité, lisibilité, choix des graphes /3 Bonus Traitement des outliers. Pertinence de la segmentation. Véritable complémentarité avec GenAI lors du travail. /2 7.2. Critères d’évaluation des travaux de groupe Critère Description Note Qualité des prompts (note individuelle pour chacun des membres du groupe) Clarté, précision, structuration, adaptation à l’objectif /2 Evaluation critique des réponses IA (note individuelle pour chacun des membres du groupe) Pertinence, capacité à repérer erreurs & limites et à rediriger l’IA vers la bonne direction /2 Profondeur analytique Qualité de l’EDA, cohérence des analyses réalisées avec du code avec les interprétations. /2 Visualisation EDA Qualité, lisibilité, choix des graphes /2 Qualité de la régression et son interprétation Le choix des variables prédictives su prix et sa justification, la préparation des variables, les essaie pour améliorer les scores de confiance, l’interprétation des coefficient de régression. /2 Qualité du rapport finale Structure, storytelling, insights, recommandations /5 Présentation finale Storytelling, insights et recommandations. Réponse aux différentes questions. /5 Note : La majorité des points pour le travail de groupes sont attribués aux livrables de présentation. Cependant, pour fournir des rapports finaux de qualité, il vous faudra mener à bien toutes les étapes d’analyse qui les sous-tendent.


Le notebook va être utilisé pour le travail de groupe.
Je veux que tu me donc toute la partie de groupe avec : 
6.6. Modélisation (uniquement projet de groupe) • Construire une régression des prix Airbnb • Choisir les variables pertinentes (ex : nombre de chambres, quartier, type de logement…) • Expliquer : o La logique métier derrière les variables. o Les coefficients du modèle. o Les limites du modèle (multicolinéarité, outliers, etc.)


Tu me fais le plan d'implémentation en français de ce que tu as compris et tant que je ne valide pas tu ne fais rien
...
*Viewed [interaction_IA_oslo.md](file:///c:/Users/jolan/D%C3%A9veloppement/dossier-iae/interaction_IA_oslo.md) *
...
*Viewed [walkthrough.md](file:///C:/Users/jolan/.gemini/antigravity/brain/a407fdf6-fcf1-4e45-ba46-ec7a8cc175b1/walkthrough.md) *
...
alors je vais te demande de lire le notebook actuelle, et de rajouter ce que tu m'as dis dans le plan d'implémentation comme Nouvelle Section donc 11ème section, je veux que tu ne touche à absolument rien du notebook d'avant
...
je veins de peaufiner encore le notebook tout seul, notamment sur l'analyse et la reformulation de tout ce que je veux et de tout ce que j'ai besoin vie à vis de la demande client, je vais te demande de lire le notebook et de rajouter ce que tu m'as dis dans le plan d'implémentation comme Nouvelle Section donc 11ème section, je veux que tu ne touche à absolument rien du notebook d'avant comme ça je ferais le remaniement après

*User accepted the command `findstr /C:"Section 11" oslo_airbnb_EDA.ipynb`*
